...
class MigrationsTest extends TestCase {
    ...
    protected $templatesDirectory = __DIR__ .DIRECTORY_SEPARATOR."templates";
    protected $migrationsDirectory = __DIR__ . DIRECTORY_SEPARATOR."migrations";
    protected $expectedMigrations = __DIR__ . DIRECTORY_SEPARATOR."expected";
    ...
    public function migrationNames() {
        return [
            [
                ...
                "$this->expectedMigrations".DIRECTORY_SEPARATOR."create_products_table.php",
            ],
            [
                "add_category_to_products_table",
                "$this->expectedMigrations".DIRECTORY_SEPARATOR."add_category_to_products_table.php",
            ],
            [
                "remove_name_from_products_table",
                "$this->expectedMigrations".DIRECTORY_SEPARATOR."remove_name_from_products_table.php",
            ],
        ];
    }
    ...
    public function test_creates_migration_files($name, $expectedMigrationFile) {
        ...
        $file = "$this->migrationsDirectory".DIRECTORY_SEPARATOR."$expectedName";
    ...
    public function test_rollback_files() {
        $tables = ["users", "products", "sellers", "providers", "referrals"];
        $migrated = [];
        foreach ($tables as $table) {
            $migrated[] = $this->migrator->make("create_{$table}_table");
        }
